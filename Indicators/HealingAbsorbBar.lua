...
local PlexusIndicatorsHealingAbsorbBar = PlexusFrame:NewModule("PlexusIndicatorsHealingAbsorbBar")
...
function PlexusIndicatorsHealingAbsorbBar:OnInitialize() --luacheck: ignore 212
    local profile = PlexusFrame.db.profile
    if profile.enableExtraBar then
        PlexusFrame:RegisterIndicator("ei_bar_barthree", "Healing Absorb Bar", New, Reset, SetStatus, Clear)
    end
end